...
class AverageCostValuationStrategy extends AbstractInventoryValuationStrategy
{
    ...
    {
        return $this->buildSequentialResult($lots, $requestedQuantity, $this->getMethod(), $context, 'average');
    }
}
